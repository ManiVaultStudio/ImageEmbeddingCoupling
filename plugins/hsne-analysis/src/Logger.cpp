...
namespace Log
{
    Logger::Logger() {
        ...
        // set up file sink
        _log_file_path = std::filesystem::current_path() / "interactiveHSNE_log.txt";
        ...
        // set sup logger
        _logger = std::make_unique<spdlog::logger>("Interactive HSNE logger", spdlog::sinks_init_list{ console_sink, file_sink });
